...
$id = $_GET["id"];
$iprestasi=query("SELECT * FROM iprestasi WHERE idip = $id")[0];
							...
							<div class="panel">
								...
								<div class="panel-body">
							    	...
							    	<div class="form-group">
							    		...
							    		<input type="text" name="semester" class="form-control" required value="<?php echo $iprestasi["semester"]; ?>">
							    	</div>
							    	<div class="form-group">
							    		<label>Nama</label>
							    		<input type="double" name="ip" class="form-control" required value="<?php echo $iprestasi["ip"]; ?>">
							    	</div>
